                            ...
                            <ul class="list-unstyled list-inline px-34 align-items-md-center justify-content-between d-flex mb-0 flex-column flex-md-row">
                                ...
                                <li class="list-inline-item">
                                    <ul class="list-unstyled list-inline mt-3 mb-lg-0 text-center text-md-end">
                                        <li class="list-inline-item"><a href="https://www.facebook.com/cf30workout/?ref=pages_you_manage" target="_blank"><img src="{{ asset('front/images/facebook.png') }}"></a></li>
                                        <li class="list-inline-item"><a href="https://www.instagram.com/cf30workout1/" target="_blank"><img src="{{ asset('front/images/instagram.png') }}"></a></li>
                                    </ul>
                                </li>                                   
                                <?php /*?>
                                <li class="list-inline-item">
