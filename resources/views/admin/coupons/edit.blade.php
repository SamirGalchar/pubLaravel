...
@section('content')
    ...
    <div class="container-fluid p-0">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form class="form-horizontal frmValidate" name="f1" id="f1" method="POST" action="{{ route('admin.coupons.update',$id) }}" enctype="multipart/form-data" novalidate="novalidate">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-5 col-12"><input type="text" class="form-control" name="coupon_code" id="coupon_code" value="{{ $coupon_code }}" placeholder="Coupon Code"></div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-5 col-12">
                            <select name="discount_type" id="discount_type" class="custom-select select2-demo valid">
                                <option value="fixed_price" @if($discount_type=="fixed_price") selected @endif >Fixed Price</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-10">
                            <input type="text" class="form-control" name="discount" id="discount" value="{{ $discount }}">
                        </div>
                        <div class="col-lg-1 col-2" style="margin-top:5px;padding-right:0px;padding-left:0px;font-size:16px;">
                            <span id="discount_type_row">@if($discount_type=="fixed_price") USD $ @else % @endif</span>
                        </div>
                    </div>
                    ...
                    <div id="validity_type_row" @if($validity_type=="limited") style="display:show;" @else style="display:none;" @endif>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-5 col-12">
                                <select name="limit_type" id="limit_type" class="custom-select select2-demo valid">
                                    <option value="numbers" @if($limit_type=="numbers") selected @endif >Numbers of times coupon will be used</option>
                                    <option value="date" @if($limit_type=="date") selected @endif >Date upto coupon is valid</option>                                
                                </select>
                            </div>
                        </div>    
                    </div>                    
                    <div class="form-group row" id="limit_numbers_row" @if($validity_type=="limited" && $limit_type=="numbers") style="display:show;" @else style="display:none;" @endif>
                        <label class="col-form-label col-lg-2 text-lg-right col-12 text-left" for="limit_numbers"> Numbers:<span class="red">*</span>&nbsp;</label>
                        <div class="col-lg-5 col-12"><input type="text" class="form-control" name="limit_numbers" id="limit_numbers" value="{{ $limit_numbers }}"></div>
                    </div>                    
                    <div class="form-group row" id="limit_date_row" @if($validity_type=="limited" && $limit_type=="date") style="display:show;" @else style="display:none;" @endif>
                        <label class="col-form-label col-lg-2 text-lg-right col-12 text-left" for="limit_date"> Date:<span class="red">*</span>&nbsp;</label>
                        <div class="col-lg-5 col-12"><input type="text" class="form-control" name="limit_date" id="limit_date" value="{{ $limit_date }}"></div>
                    </div>
                    
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2 text-lg-right col-12 text-left" for="notification_email">Notification Email:</label>
                        <div class="col-lg-5 col-12"><input type="text" class="form-control" name="notification_email" id="notification_email" value="{{ $notification_email }}" placeholder="Notification Email"></div>
                    </div>
            ...
            $(document).ready(function () {
                ...
                $('#f1').validate({
                    rules:{
                        coupon_code: {
                            required: true,
                            remote: {url: "{{ route('admin.check-coupon-code') }}",type: "post",data:{'_token': '{{ csrf_token() }}', 'id':"{{ $id }}" }}
                        },
