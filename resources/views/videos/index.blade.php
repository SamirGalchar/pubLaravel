                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-sm-12 col-md-10 col-lg-12">
                            <p class="barlow medium font-20 color-f2f3f4 lh-27  ls_1 text-center">For fitness support, email us at 
                                <a class="text-white text-decoration-none" href="mailto:fitnessconsultant@fit-30.online">fitnessconsultant@fit-30.online</a>
                            </p>
                            <p class="barlow medium font-20 color-f2f3f4 lh-27  ls_1 text-center">For nutrition guidelines, email us at 
                                <a class="text-white text-decoration-none" href="mailto:nutritionist@fit-30.online">nutritionist@fit-30.online</a>
                                <?php /* ?><span style="font-size:6px;"><a class="text-white text-decoration-none" href="{{ route('user.unsubscribe') }}">Unsubscribe Videos</a></span><?php */ ?>
                            </p>                        
                        </div>
                    </div>                    
                @endif
